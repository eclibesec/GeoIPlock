...
def get_location(ip):
    ...
    return None
def filter_ips(ip_list, countries, output_file, thread_count):
    lock = threading.Lock()
...
- GeoIPlocker
    """)
    file_path = input("$ Give me your ip list: ")
    countries = input("$ Lock Countries [ex: indonesia,malaysia,thailand]: ")
    ...
    filter_ips(ip_list, countries, output_file, thread_count)